...
import { Upload, Map as MapIcon, Calendar, TrendingUp, Info, XCircle, EyeOff, Filter, SlidersHorizontal, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function App() {
  ...
  // Chart Rendering
  useEffect(() => {
    if (!echartsReady || !chartRef.current || data.length === 0) return;
  ...
  }, [data, timeframe, trendType, echartsReady, disabledRoutes, activeCountries, activeDestCountries, minAdOppFilter]);
